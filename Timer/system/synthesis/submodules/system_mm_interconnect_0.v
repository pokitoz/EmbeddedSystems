...
// 
// Generated using ACDS version 14.1 186 at 2015.02.23.10:54:45
...
module system_mm_interconnect_0 (
	...
	wire    [5:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> pll_pll_slave_agent:cp_channel
	...
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> timer_timer_slave_0_agent:cp_valid
	wire  [101:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> timer_timer_slave_0_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // timer_timer_slave_0_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> timer_timer_slave_0_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> timer_timer_slave_0_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> timer_timer_slave_0_agent:cp_endofpacket
	...
	wire          timer_timer_slave_0_agent_rp_valid;                                                 // timer_timer_slave_0_agent:rp_valid -> router_007:sink_valid
	wire  [101:0] timer_timer_slave_0_agent_rp_data;                                                  // timer_timer_slave_0_agent:rp_data -> router_007:sink_data
	wire          timer_timer_slave_0_agent_rp_ready;                                                 // router_007:sink_ready -> timer_timer_slave_0_agent:rp_ready
	wire          timer_timer_slave_0_agent_rp_startofpacket;                                         // timer_timer_slave_0_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          timer_timer_slave_0_agent_rp_endofpacket;                                           // timer_timer_slave_0_agent:rp_endofpacket -> router_007:sink_endofpacket
