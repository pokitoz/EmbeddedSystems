...
// 
// Generated using ACDS version 14.1 186 at 2015.03.02.09:46:30
...
module system_mm_interconnect_0 (
	...
	wire    [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> pll_pll_slave_agent:cp_channel
	...
	wire  [101:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> leds_s1_agent:cp_data
	...
	wire  [102:0] inputs_s1_agent_rf_source_data;                                                     // inputs_s1_agent:rf_source_data -> inputs_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] inputs_s1_agent_rsp_fifo_out_data;                                                  // inputs_s1_agent_rsp_fifo:out_data -> inputs_s1_agent:rf_sink_data
	...
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> inputs_s1_agent:cp_valid
	wire  [101:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> inputs_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // inputs_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> inputs_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> inputs_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> inputs_s1_agent:cp_endofpacket
	...
	wire  [101:0] leds_s1_agent_rp_data;                                                              // leds_s1_agent:rp_data -> router_006:sink_data
	...
	wire          inputs_s1_agent_rp_valid;                                                           // inputs_s1_agent:rp_valid -> router_007:sink_valid
	wire  [101:0] inputs_s1_agent_rp_data;                                                            // inputs_s1_agent:rp_data -> router_007:sink_data
	wire          inputs_s1_agent_rp_ready;                                                           // router_007:sink_ready -> inputs_s1_agent:rp_ready
	wire          inputs_s1_agent_rp_startofpacket;                                                   // inputs_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          inputs_s1_agent_rp_endofpacket;                                                     // inputs_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
